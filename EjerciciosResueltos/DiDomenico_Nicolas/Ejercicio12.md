...
- Qué: Buscar formas de que los estudiantes amplíen su conocimiento más allá del aula y además incentivar a cada alumno para concientizar de la importancia de seguir indagando en el tema de interés.
...
|-----------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|
|Eliminar desperdicios                    |Identificar y eliminar todo lo que no agrega valor al producto o servicio final.  Los desperdicios pueden ser en forma de tiempo, recursos, inventarios, movimientos innecesarios, etc.  |Reducción de inventarios, simplificación de procesos, eliminación de pasos innecesarios                         |
...
|Decidir lo más tarde posible             |Tomar decisiones importantes con la mayor cantidad de información posible, evitando comprometerse prematuramente a un curso de acción específico.                                        |Prototipado rápido, decisiones basadas en datos, flexibilidad en los procesos                                   |
|Entregar rápido                          |Acortar los ciclos de entrega para proporcionar valor al cliente de manera rápida y eficiente, permitiendo iteraciones y mejoras frecuentes.                                             |Desarrollo ágil, entregas incrementales, sprints cortos                                                         |
|Respetar a la gente, potenciar el equipo |Valorar y respetar a todos los miembros del equipo, proporcionándoles las herramientas y el entorno necesario para que puedan desempeñarse al máximo de su capacidad.                    |Autonomía del equipo, liderazgo servicial, desarrollo de habilidades y crecimiento profesional                  |
